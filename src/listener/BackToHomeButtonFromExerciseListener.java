...
public class BackToHomeButtonFromExerciseListener extends Listener implements EventHandler<ActionEvent> {

    public BackToHomeButtonFromExerciseListener(FoodModel foodModel, LogModel logModel, ExerciseModel exerciseModel,
            MainView mainView,
