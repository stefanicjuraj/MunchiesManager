...
public class FoodConsumptionButtonListener extends Listener implements EventHandler<ActionEvent> {

  public FoodConsumptionButtonListener(FoodModel foodModel, LogModel logModel, ExerciseModel exerciseModel,
      MainView mainView,
  ...
  public void handle(ActionEvent event) {
    super.getMainView().displayComponentView(super.getFoodConsumption());
