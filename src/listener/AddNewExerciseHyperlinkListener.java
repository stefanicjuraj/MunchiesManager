...
public class AddNewExerciseHyperlinkListener extends Listener implements EventHandler<ActionEvent> {

    public AddNewExerciseHyperlinkListener(FoodModel foodModel, LogModel logModel, ExerciseModel exerciseModel,
            MainView mainView,
